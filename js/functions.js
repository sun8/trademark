...
var floating_window_onOff = true;
$('#openUp').on('click',function(){
  if(floating_window_onOff){
    $('#openUp').css('color','#fff');
    $('#floating_window>.phone').animate({
      top: 0,
    }, 100 );
    $('#floating_window>.email').animate({
      top: '45px',
    }, 100 );
    $('#floating_window>.commenting').animate({
      top: '135px',
    }, 100 );
    $('#floating_window>.search').animate({
      top: '180px',
    }, 100 );
    floating_window_onOff = false;
  }else{
    $('#openUp').css('color','#fff');
    $('#floating_window>.phone').animate({
      top: '90px'
